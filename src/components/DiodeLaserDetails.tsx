/**
 * Custom 810nm Diode Laser details page
 *
 * A personalized page for the 810nm wavelength entry with
...
// Get clinical grade machines that use 810nm wavelength, sorted by brand tier (gold standard first)
const machines810nm = equipment
  .filter(isMachine)
...
interface DiodeLaserDetailsProps {
  term: TechnologyTermEntry;
}

/**
 * Custom 810nm Diode Laser page layout
 */
export function DiodeLaserDetails({ term }: DiodeLaserDetailsProps) {
