/**
 * Custom 755nm Alexandrite Laser details page
 *
 * A personalized page for the 755nm wavelength entry with
 * educational content about Alexandrite lasers and quality variations.
 */
...
// Get clinical grade machines that use 755nm wavelength, sorted by brand tier (gold standard first)
const machines755nm = equipment
  .filter(isMachine)
...
interface AlexandriteLaserDetailsProps {
  term: TechnologyTermEntry;
}

/**
 * Custom 755nm Alexandrite Laser page layout
 */
export function AlexandriteLaserDetails({ term }: AlexandriteLaserDetailsProps) {
